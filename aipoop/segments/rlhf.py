...
def gen_rlhf_segment(
    ...
    for f in range(30):
        img = Image.new("RGB", (constants.WIDTH, constants.HEIGHT), (15, 10, 30))
        draw = ImageDraw.Draw(img)
        draw.text((40, 40), "RLHF TRAINING — ROUND 4,847,293", font=get_font(22), fill=(100, 80, 150))
        draw.line([(40, 75), (constants.WIDTH - 40, 75)], fill=(60, 40, 100))
    ...
    for f in range(60):
        ...
        mid_x = constants.WIDTH // 2
        draw.rectangle([(20, 120), (mid_x - 10, constants.HEIGHT - 200)], outline=(100, 40, 40))
        ...
        draw.rectangle([(mid_x + 10, 120), (constants.WIDTH - 20, constants.HEIGHT - 200)], outline=(40, 100, 40))
        ...
        if f >= 30:
            ...
            draw.text((40, constants.HEIGHT - 180), f"reward: {reward_h}", font=score_font, fill=(255, 0, 0))
            draw.text((mid_x + 30, constants.HEIGHT - 180), f"reward: {reward_s}", font=score_font, fill=(0, 255, 0))

            if f % 6 < 3:
                draw.rectangle([(20, 120), (mid_x - 10, constants.HEIGHT - 200)], outline=(255, 0, 0), width=3)
    ...
    for f in range(20):
        ...
        img = render_text_frame(constants.WIDTH, constants.HEIGHT, lesson_text, bg, (255, 255, 0), font_size=64, bold=True)
